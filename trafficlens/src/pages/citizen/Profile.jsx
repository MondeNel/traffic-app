        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-3.5">
          <div className="bg-white border border-[#E2E8F0] rounded-[10px] p-4">
            ...
            <div className="space-y-0">
              <div className="flex justify-between items-center py-1.5 border-b border-[#E2E8F0]">
                ...
                <span className="text-xs font-medium text-[#0F172A]">{demoUser.first_name} {demoUser.last_name}</span>
              </div>
              <div className="flex justify-between items-center py-1.5 border-b border-[#E2E8F0]">
              ...
              <div className="flex justify-between items-center py-1.5 border-b border-[#E2E8F0]">
                <label className="text-[11px] text-[#94A3B8]">ID Number</label>
                <span className="text-xs font-medium text-[#0F172A]">{demoUser.id_number}</span>
              </div>
              <div className="flex justify-between items-center py-1.5 border-b border-[#E2E8F0]">
              ...
              <div className="flex justify-between items-center py-1.5">
                ...
                <span className="text-xs font-medium text-[#0F172A]">{demoUser.address}</span>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-[10px] p-3.5">
            ...
            {[
              ...
              <div key={item.key} className={`flex items-start justify-between py-2 gap-2.5 ${index < arr.length - 1 ? 'border-b border-[#E2E8F0]' : ''}`}>
                <div>
