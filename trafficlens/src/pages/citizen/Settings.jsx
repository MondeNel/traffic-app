            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-3.5">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-2">
                ...
                {Array(5).fill(null).map((_, i) => (
                  <div key={i} className={`flex justify-between items-center py-2 ${i < 4 ? 'border-b border-slate-200' : ''}`}>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-2.5">
                ...
                {Array(6).fill(null).map((_, i) => (
                  <div key={i} className={`flex items-center justify-between py-2.5 ${i < 5 ? 'border-b border-slate-200' : ''}`}>
                    <div className="space-y-1 flex-1">
                      <Skeleton className="h-3 w-36" />
                      <Skeleton className="h-2 w-48" />
                    </div>
                    <Skeleton className="w-[34px] h-[19px] rounded-full shrink-0" />
                  </div>
                ))}
              </div>
            </div>
